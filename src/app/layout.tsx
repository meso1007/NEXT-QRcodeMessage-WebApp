...
export const metadata: Metadata = {
  ...
  description:
    "大切な人への想いやメッセージを、安全で意味のある形で残すためのプラットフォームです。QRコードを通じて、あなたの想いを未来へ届けます。",
  keywords:
    "メッセージ, QRコード, 想い, メモリー, デジタルレター, 大切な人へのメッセージ, 電子手紙, 電子遺書, 手紙",
  ...
  openGraph: {
    type: "website",
    locale: "ja_JP",
    url: "https://otodokelife.com",
    siteName: "OTODOKE LIFE",
    title: "OTODOKE LIFE - 大切な人への想いを残す場所",
    description:
      "大切な人への想いやメッセージを、安全で意味のある形で残すためのプラットフォームです。",
    images: [
      {
  ...
  verification: {
    google: "your-google-site-verification", // Google Search Console用
  },
};
